  ...
  return (
    <div style={{ background: '#fff' }}>
      ...
      <section style={{ padding: sectionPad }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 36 : 60, marginTop: 44, alignItems: 'start' }}>
          <div>
            {[
      ...
      <section style={{ padding: sectionPad, background: '#F0F4F8' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2,1fr)' : 'repeat(4,1fr)', gap: 1, background: '#C4BAB0', border: '1px solid #C4BAB0', marginTop: 32, borderRadius: 6, overflow: 'hidden' }}>
      ...
      <section style={{ padding: sectionPad }}>
        ...
        <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: isMobile ? 32 : 42, fontWeight: 500, color: '#1A2744', margin: '0 0 16px', lineHeight: 1.1 }}>What We <em style={{ fontStyle: 'italic' }}>Stand For</em></h2>
        <p style={{ fontSize: 15, color: '#6B6560', maxWidth: 540, lineHeight: 1.75 }}>Five principles that shape every engagement we take on.</p>
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 1, background: '#C4BAB0', border: '1px solid #C4BAB0', borderRadius: 6, overflow: 'hidden', marginTop: 44 }}>
          {[
          ...
          <div style={{ background: '#fff', padding: 28, gridColumn: isMobile ? 'auto' : '1/-1' }}>
