  ...
  return (
    <div style={{ background: '#fff' }}>
      ...
      <section style={{ padding: sectionPad }}>
        ...
        <div style={{ marginTop: 48 }}>
          {STEPS.map(([n, title, desc]) => (
            <div key={n} style={{ display: 'grid', gridTemplateColumns: isMobile ? '44px 1fr' : '56px 1fr', gap: isMobile ? 16 : 24, alignItems: 'start', paddingBottom: 28, marginBottom: 28, borderBottom: '1px solid #C4BAB0' }}>
      ...
      <section style={{ padding: sectionPad, background: '#F0F4F8' }}>
        ...
        <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: isMobile ? 32 : 42, fontWeight: 500, color: '#1A2744', margin: '0 0 32px', lineHeight: 1.1 }}>Common <em style={{ fontStyle: 'italic' }}>Questions</em></h2>
        {FAQS.map(([q, a]) => (
      ...
      <div style={{ background: '#1A2744', padding: isMobile ? '56px 24px' : '72px 48px', textAlign: 'center' }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: isMobile ? 36 : 46, fontWeight: 500, color: '#fff', margin: '0 0 16px', lineHeight: 1.1 }}>Ready to get<br /><em style={{ fontStyle: 'italic', color: '#A27021' }}>started?</em></h2>
