...
const Footer = ({ setPage }) => {
  ...
  return (
    <footer style={{
      background: '#10192E',
      padding: isMobile ? '40px 24px 24px' : '52px 48px 30px',
      display: 'grid',
      ...
      <div style={{ gridColumn: '1/-1', borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 22, marginTop: 8, display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'space-between', gap: isMobile ? 6 : 0 }}>
