...
const HomePage = ({ setPage }) => (
  <div style={{ background: '#fff' }}>
    {/* HERO */}
    <section style={{ background: '#1A2744', padding: '88px 48px 80px', position: 'relative', overflow: 'hidden' }}>
      ...
      <h1 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 60, fontWeight: 500, lineHeight: 1.07, color: '#fff', margin: '0 0 30px', maxWidth: 580 }}>
      ...
      <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.62)', maxWidth: 480, margin: '0 0 38px', lineHeight: 1.75 }}>
    ...
    {/* VALUE STRIP */}
    <div style={{ background: '#F0F4F8', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', borderBottom: '1px solid #C4BAB0' }}>
      {[
        ...
        <div key={label} style={{ padding: '30px 36px', borderRight: '1px solid #C4BAB0' }}>
    ...
    <section style={{ padding: '72px 48px', background: '#fff' }}>
      ...
      <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 42, fontWeight: 500, color: '#1A2744', margin: '0 0 16px', lineHeight: 1.1 }}>
        Most consultancies <em style={{ fontStyle: 'italic' }}>talk</em><br />about hospitality.<br />We've worked in it.
      </h2>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'start', marginTop: 44 }}>
        <div style={{ fontSize: 15, lineHeight: 1.8, color: '#1A2744' }}>
          <p style={{ margin: '0 0 18px', color: '#1A2744' }}>Over a decade across kitchens, bars, front of house and management — in independent venues across the West Midlands and Scotland. The advice we give is practical because it comes from someone who has actually stood where you're standing.</p>
          <p style={{ margin: '0 0 18px', color: '#1A2744' }}>The Fifth Course works with independent food and drink operators at every stage — from established venues looking to tighten their margins, to businesses preparing to open their second site.</p>
          <p style={{ color: '#1A2744' }}>No jargon. No corporate playbook. No generalist advice adapted from somewhere else. Just honest, commercial support from someone who gets it.</p>
        </div>
        <div style={{ borderLeft: '2px solid #A27021', padding: '22px 26px', background: '#EEF2F7', borderRadius: '0 6px 6px 0' }}>
          <p style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 23, fontStyle: 'italic', color: '#1A2744', margin: '0 0 14px', lineHeight: 1.42 }}>
    ...
    <section style={{ padding: '72px 48px', background: '#F0F4F8' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1, background: '#C4BAB0', border: '1px solid #C4BAB0', marginTop: 52, borderRadius: 6, overflow: 'hidden' }}>
        {services.map(s => (
    ...
    {/* FOUNDER */}
    <div style={{ background: '#1A2744', padding: '64px 48px', display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 52, alignItems: 'center' }}>
      ...
      <div>
        ...
        <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 34, fontWeight: 500, color: '#fff', margin: '0 0 14px' }}>Meet Kendal Pierce</h3>
    ...
    {/* CREDS */}
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 1, background: '#C4BAB0', borderBottom: '1px solid #C4BAB0' }}>
      {creds.map(c => (
